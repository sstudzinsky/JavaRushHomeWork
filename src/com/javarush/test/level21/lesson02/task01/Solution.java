...
public class Solution {
    public static void main(String[] args) {
        ...
        String s = Integer.toBinaryString(192);
        //System.out.println(s);
        String k = Integer.toBinaryString(255);
...
//        System.out.println(t);
    ...
    public static void print(byte[] bytes) {
        for (Byte aByte : bytes) {
            String buf = Integer.toBinaryString(256  + (int)aByte);
            String s = buf.substring(buf.length() - 8);
            System.out.print(s + " ");
        }
        System.out.println();
    }
